...
@pytest.mark.django_db
def test_method_without_the_flag_reads_as_unverified(client, event, event_admin, user_model) -> None:
    """Provenance without the flag is not a verification; the column must not show connected."""
