"""Squad picker + roster helpers shared by the planners.

Active events are visible events that haven't ended. A squad's roster for picker
purposes is the union of its MEMBER ``SquadMember`` users plus its captains and
vice-captains. Used by both the ladder planner and the TTT planner to add a whole
squad to a lineup.
"""
